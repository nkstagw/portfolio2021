...
<main>
  ...
  <section class="topTxt">
    <div class="topTxt__container inner">
      ...
      <p class="topTxt__txt">AIGVではお客様にとって一番「お節介な人」になる事を目指して活動しております。事業において人や課題に自ら積極的に関わり、その課題解決に向けて全力で取り組む事を大切にしております。ただのお節介ではなくお客様にとって「良い意味でお節介な人」を目指して様々な活動をしております。</p>
    </div>
  </section>
  <section class="value">
      ...
      <div class="value__content">
        <div class="value__card">
          <div class="value__cardCnt">
            ...
            <p class="value__cardTxt">積極的に人や課題に対して関わっていきます。関わっていく中で課題の本質を捉え、表面化している課題だけでなく潜在化している課題に気づきお客様に沿ったご提案をしていきます。そして最終的にお客様「あなたにお願いしてよかった」と言ってもらえるような行動を意識しております。</p>
          </div>
        ...
        <div class="value__card">
          <div class="value__cardCnt">
            ...
            <p class="value__cardTxt">「節介」とは本来、【節操を守って世俗に流れない事】という意味があります。その言葉のように一般的な常識や枠に囚われる事なく、様々な考えを持ち目的・目標に向かって進んでいきます。</p>
          </div>
          <div class="value__cardImg">
        ...
        <div class="value__card">
          <div class="value__cardCnt">
            ...
            <p class="value__cardTxt">お客様にとって「本当の価値」の提供を行います。Webサイトを制作するだけでなく、お客様が求めている価値を見極め、先を見据えた行動からお願いされたことに対して常に120％の成果を出していきます。</p>
          </div>
          <div class="value__cardImg">
