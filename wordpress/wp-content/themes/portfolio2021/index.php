...
<main>
  <section class="fv">
    <ul class="fv__items">
      <li class="fv__item"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/fv_1@2x.png" alt=""></li>
      <li class="fv__item"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/fv_2@2x.png" alt=""></li>
  ...
  <section class="service">
    <div class="service__container inner">
      <div class="service__head">
        ...
        <p class="section__txt">Web制作に関する課題に対して、様々なサービスをご用意しております。顧客の獲得や事業の周知を目的としたWebサイト・ランディングページ制作、お客様自身で最新情報などの更新を行いたい際に有効なWordPressによるWebサイト実装、Web制作に関する外注パートナーなどのご提案をしております。</p>
      </div>
        ...
        <div class="service__cards">
          ...
          <div class="service__card">
            <div class="service__cardCnt">
              ...
              <p class="service__cardTxt">新規の顧客獲得や事業の周知などお客様の目的や課題に沿ったWebサイト・ランディングページの制作を行います。同じ業種や分野であってもお客様によって解決するべき課題は異なります。その課題解決のためにお客様と一緒に作り上げていきます。また近年のWebサイトはPCサイズだけでなくタブレットやスマートフォンなど画面のサイズを様々であるためレスポンシブ対応するなど、時代にあったWebサイト制作を行います。</p>
            </div>
          ...
          <div class="service__card">
            <div class="service__cardCnt">
              ...
              <p class="service__cardTxt">最新情報のお知らせや商品の紹介など頻繁に更新が必要なWebサイトについては「WordPress」での実装をお勧めしております。「WordPress」はWebサイト構築などの専門知識を持っていない場合でもお知らせや追加したいページなどお客様自身で更新を行なっていただけるサービスになります。Webサイトの構築もテンプレートを使用したものから、オリジナルのレイアウトのものまで様々ありますので、お客様のご予算などに合わせてご提案いたします。</p>
            </div>
            <div class="service__cardImg">
          ...
          <div class="service__card">
            <div class="service__cardCnt">
              ...
              <p class="service__cardTxt">Web制作の外注パートナーとしての活動も行なっております。ただの作業者ではなく「どうすればお役に立つ事ができるか」「自分から提供できる価値は何か」を常に考えていきます。品質や納期、レスポンスの速さなどのコミュニケーションコストをかけないといった部分はもちろんの事、お客様のご要望に対して柔軟に対応しさらにより良いものを作るために、こちらから提案などもさせて頂きながら目的達成に向かって積極的に行動していきます。</p>
            </div>
            <div class="service__cardImg">
